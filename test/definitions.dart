...
void main() {
  group('Definitions', () {
    test('initialValues default values', () {
      ...
      expect(
          Definitions.initialValues[NOTIFICATION_GROUP_SORT], GroupSort.Desc);
      expect(Definitions.initialValues[NOTIFICATION_GROUP_ALERT_BEHAVIOR],
          GroupAlertBehavior.All);
      expect(Definitions.initialValues[NOTIFICATION_IMPORTANCE],
          NotificationImportance.Default);
      expect(Definitions.initialValues[NOTIFICATION_LAYOUT],
          NotificationLayout.Default);
      expect(Definitions.initialValues[NOTIFICATION_DEFAULT_PRIVACY],
          NotificationPrivacy.Private);
      expect(Definitions.initialValues[NOTIFICATION_ACTION_TYPE],
          ActionType.Default);
      expect(Definitions.initialValues[NOTIFICATION_PRIVACY],
          NotificationPrivacy.Private);
      expect(Definitions.initialValues[NOTIFICATION_DEFAULT_RINGTONE_TYPE],
          DefaultRingtoneType.Notification);
      expect(
          Definitions.initialValues[NOTIFICATION_DISPLAY_ON_FOREGROUND], true);
      expect(
          Definitions.initialValues[NOTIFICATION_DISPLAY_ON_BACKGROUND], true);
      expect(Definitions.initialValues[NOTIFICATION_CHANNEL_DESCRIPTION],
          'Notifications');
      expect(Definitions.initialValues[NOTIFICATION_CHANNEL_NAME],
          'Notifications');
      ...
      expect(
          Definitions.initialValues[NOTIFICATION_SHOW_IN_COMPACT_VIEW], true);
      ...
      expect(
          Definitions.initialValues[NOTIFICATION_ROUNDED_BIG_PICTURE], false);
    });
  });
}
