...
//            if(SafeEnum.charMatches(reference, stringLength, 4, 'a')) return DisabledAction;
//            return DismissAction;
//        }
//        else if (SafeEnum.charMatches(reference, stringLength, 0, 's')){
//            if(SafeEnum.charMatches(reference, stringLength, 6, 'a')) return SilentAction;
//            return SilentBackgroundAction;
//        }
//        else if (SafeEnum.charMatches(reference, stringLength, 0, 'k')){
//            return KeepOnTop;
//        }
//        else if (SafeEnum.charMatches(reference, stringLength, 0, 'i')){
//            return InputField;
//        }
        return null;
    }
