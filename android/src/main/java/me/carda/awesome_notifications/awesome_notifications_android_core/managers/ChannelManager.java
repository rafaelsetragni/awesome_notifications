...
import me.carda.awesome_notifications.awesome_notifications_android_core.utils.AudioUtils;
...
public class ChannelManager {
    ...
    public ChannelManager saveChannel(Context context, NotificationChannelModel newChannel, Boolean forceUpdate) throws AwesomeNotificationException {
        saveChannel(context, newChannel, true, forceUpdate);
        return this;
    }

    public void saveChannel(Context context, NotificationChannelModel newChannel, Boolean allowUpdates, Boolean forceUpdate) throws AwesomeNotificationException {
