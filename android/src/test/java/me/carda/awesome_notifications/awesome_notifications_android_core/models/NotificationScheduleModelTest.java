...
public class NotificationScheduleModelTest {
    ...
    public void fromJsonAndToJson() {
        ...
        intervalModel.fromMap(new HashMap<>());
    ...
    public void hasNextValidDate() throws Exception {
        ...
        NotificationScheduleModel testScheduleModel = new NotificationScheduleModel() {
    ...
    public void getScheduleModelFromMap() {
        ...
        assertNull("", NotificationScheduleModel.getScheduleModelFromMap(new HashMap<>()));
