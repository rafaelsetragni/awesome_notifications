...
/// An implementation of [AwesomeNotifications] that uses method channels.
class AwesomeNotificationsCore extends AwesomeNotificationsPlatform {
  String TAG = 'AwesomeNotificationsCore';

  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel(CHANNEL_FLUTTER_PLUGIN);
