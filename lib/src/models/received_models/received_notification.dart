...
class ReceivedNotification extends BaseNotificationContent {
  ...
  ReceivedNotification fromMap(Map<String, dynamic> dataMap) {
    ...
    createdSource    = AssertUtils.extractEnum<NotificationSource>(dataMap, 'createdSource', NotificationSource.values);
    createdLifeCycle = AssertUtils.extractEnum<NotificationLifeCycle>(dataMap, 'createdLifeCycle', NotificationLifeCycle.values);
    displayedLifeCycle    = AssertUtils.extractEnum<NotificationLifeCycle>(dataMap, 'displayedLifeCycle', NotificationLifeCycle.values);
