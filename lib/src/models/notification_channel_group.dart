...
class NotificationChannelGroup extends Model {
  ...
  NotificationChannelGroup? fromMap(Map<String, dynamic> dataMap) {
    channelGroupkey = AssertUtils.extractValue(NOTIFICATION_CHANNEL_GROUP_KEY, dataMap, String);
    channelGroupName = AssertUtils.extractValue(NOTIFICATION_CHANNEL_GROUP_NAME, dataMap, String);
  ...
  void validate() {
    if (AssertUtils.isNullOrEmptyOrInvalid(channelGroupkey, String))
      throw AwesomeNotificationsException(message: 'channelGroupkey is requried');
    if (AssertUtils.isNullOrEmptyOrInvalid(channelGroupName, String))
      throw AwesomeNotificationsException(message: 'channelGroupName is requried');
  }
}
