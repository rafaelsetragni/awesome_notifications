...
///IOS CONFIG BUTTONS
const METHOD_CONFIG_BUTTON_NOTIFICATION_ACTION_BACKGROUND = "METHOD_CONFIG_BUTTON_NOTIFICATION_ACTION_BACKGROUND";
...
const CHANNEL_METHOD_ACTION_RECEIVED_BACKGROUND_IOS = "CHANNEL_METHOD_ACTION_RECEIVED_BACKGROUND_IOS";
const ACTION_BACKGROUND_HANDLE = 'receivedActionCallbackHandle';
const CHANNEL_METHOD_INIT_BACKGROUND = 'initBackground';
const METHOD_RECEIVED_OTHER_NOTIFICATION_IOS = "METHOD_RECEIVED_OTHER_NOTIFICATION";
