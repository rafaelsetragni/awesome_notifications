...
* Android: is required the minimum android SDK to 23 (Android 6.0 Marshmallow). You can change the minSdkVersion to 21, inside the file build.gradle in "android/app" folder.
