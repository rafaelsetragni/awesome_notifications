...
Bellow there is a full example of how to check if the desired permission is enable, request it and look if you should prompt a dialog with a rationale (this example was took from our example app):
