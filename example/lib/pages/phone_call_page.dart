...
class RoundedButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: size,
      width: size,
      // FlatButton was deprecated in a previous version of Flutter, being removed in Flutter 3.
      // Replaced FlatButton with TextButton

      //(iamcosmin) If styling is not correct, please reach out to me for correction.
      child: TextButton(
